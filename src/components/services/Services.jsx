        ...
        <section className="services section" id="services">
            ...
            <div className="services_container container grid">
                ...
                <div className="services_content">
                    <div>
                        <i className="uil uil-web-grid service_icon"/>
                    ...
                    <div className={toggleState === 1 ? "services_modal active-modal" : "services_modal"}>
                        <div className="services_modal-content">
                            ...
                            <div className="services_modal-title">Product Designer</div>
                ...
                <div className="services_content">
                    <div>
                        <i className="uil uil-arrow service_icon"/>
                    ...
                    <div className={toggleState === 2 ? "services_modal active-modal" : "services_modal"}>
                        <div className="services_modal-content">
                            <i onClick={() => toggleTab(0)} className="uil uil-times services_modal-close"/>
                            <div className="services_modal-title">Ui/Ux Designer</div>
                            <p className="services_modal-description">
                                Services with more than 1 year of experience.
                                Providing quality work to clients and companies
                            </p>
                ...
                <div className="services_content">
                    <div>
                        <i className="uil uil-edit service_icon"/>
                    ...
                    <div className={toggleState === 3 ? "services_modal active-modal" : "services_modal"}>
                        <div className="services_modal-content">
                            <i onClick={() => toggleTab(0)} className="uil uil-times services_modal-close"/>
                            <div className="services_modal-title">Visual Designer</div>
                            <p className="services_modal-description">
                                Services with more than 1 year of experience.
                                Providing quality work to clients and companies
                            </p>
