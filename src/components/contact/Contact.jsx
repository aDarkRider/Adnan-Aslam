...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs.sendForm("service_3n2tmwo", "template_udrplya", form.current, "7YfkID4b3VDB2I1-j")
            e.target.reset()
    };
                ...
                <div className="contact_content">
                    ...
                    <div className="contact_info">
                        <div className="contact_card">
                            ...
                            <a href="mailto:example@gmail.com" className="contact_button">Write me <i className="bx bx-right-arrow-alt contact_button-icon"/></a>
                        ...
                        <div className="contact_card">
                            ...
                            <span className="contact_card-data">+921234567890</span>

                            <a href="https://api.whatsapp.com/send?phone=1234567890&text=Hello, more information!" className="contact_button">Write me <i className="bx bx-right-arrow-alt contact_button-icon"/></a>

                        </div>

                        <div className="contact_card">
                            <i className="bx bxl-messenger contact_card-icon"/>

                            <h3 className="contact_card-title">Messenger</h3>
                            <span className="contact_card-data">user.fb123</span>

                            <a href="https://m.me//crypticalcoder" className="contact_button">Write me <i className="bx bx-right-arrow-alt contact_button-icon"/></a>
